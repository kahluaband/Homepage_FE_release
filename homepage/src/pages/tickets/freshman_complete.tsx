                ...
                <div className="mt-[32px] sm:mt-[64px] flex flex-col mx-auto ">
                    ...
                    <div className="sm:ml-[0.5vw] ">
                        <div className="mt-[12px] sm:mt-[32px] flex flex-row items-center">
                            ...
                            <div className="ml-[2vw] sm:ml-[5.5vw] text-[10px] sm:text-[16px] font-[500] w-[35vw] leading-[21px] text-[#281CFF]">{reservation_id}</div>
                        </div>
                        <div className="mt-[12px] sm:mt-[32px] flex flex-row items-center">
                        ...
                        <div className="mt-[12px] sm:mt-[32px] flex flex-row items-center">
                            <div className="text-[12px] sm:text-[20px] w-[100px] font-[500] leading-[0.4px]">학번</div>
                            <div className="ml-[2vw] sm:ml-[5.5vw] text-[10px] sm:text-[16px] font-[500] w-[35vw] leading-[21px] text-[#6A6A6A]">{student_id}</div>
                        </div>
                        <div className="mt-[12px] sm:mt-[32px] flex flex-row items-center">
                        ...
                        <div className="mt-[12px] sm:mt-[32px] flex flex-row items-center">
                            ...
                            <div className="ml-[2vw] sm:ml-[5.5vw] text-[10px] sm:text-[16px] font-[500] w-[35vw] leading-[21px] text-[#979797]">예매완료</div>
                        </div>
                        </div>
