        ...
        <div className="font-pretendard w-auto h-auto bg-[#FFF] flex-shrink-0 fixed rounded-[10px] z-20 sm:pb-[60px] pb-[26px] px-[12px]">
          ...
          <div className="flex flex-col items-center text-center content-center mt-[4px] sm:mt-[40px] leading-normal">
            <Image
              ...
              width={52}
              height={12}
              className="sm:w-[52px] sm:h-[12px] w-[30px] h-[10px]"
            />
            <p className="font-[700] mt-[12px] text-[12px] sm:text-[24px] leading-[28px]">
              제출한 이후에는 수정할 수 없습니다.
            </p>
            <p className="font-[700] mt-[4px] text-[12px] sm:text-[24px] leading-[28px]">
              제출하시겠습니까?
            </p>
            <p className="mt-[8px] sm:mt-[20px] sm:font-[500] text-[8px] sm:text-[14px] leading-[21px] text-[#4A4A4A]">
  ...
  return (
    <>
      <div className="py-8 flex flex-col justify-start">
        ...
        <div className="mt-8 text-base mr-auto">
          <Checkbox checked={monday} onChange={setMonday}>
            홍익대학교 깔루아 23기는{" "}
            <span className="text-ocean">매주 월요일 오후 6시 오프라인</span>
            으로 정기 회의와 뒷풀이를 진행할 예정이고, 장소는 홍익대학교 T동
            건물입니다. 매주 진행되는 깔루아 정기 회의 및 뒷풀이에 필수로 참여할
            수 있는 분만 지원해주시기 바랍니다.
          </Checkbox>
        </div>
        <div className="mt-8 text-base mr-auto">
          <Checkbox checked={duration} onChange={setDuration}>
            홍익대학교 깔루아 23기의{" "}
            <span className="text-ocean">활동 기간은 1년 6개월</span>로, 25년
            9월 공연까지는 필수로 참여해야 합니다.
          </Checkbox>
        </div>
        <div className="mt-8 text-base mr-auto">
          <Checkbox checked={cost} onChange={setCost}>
            홍익대학교 깔루아는 공연이 있는 3월, 9월을 제외하고{" "}
            <span className="text-ocean">매달 1만원의 회비</span>를 냅니다. 이
            회비는 깔루아 전체 회비로 입금되며, 이 전체 회비는 동방 장비 수리,
            교체, 공연 준비를 위한 비용으로 사용됩니다.
          </Checkbox>
        </div>
      ...
      <div className="flex flex-col justify-center pb-10">
        ...
        <div className="mt-8">
          ...
          <textarea
            ...
            className="text-sm s:text-base w-full h-[120px] flex-shrink-0 border border-[#464646] border-solid rounded-[10px] mt-4 p-4"
            placeholder=""
      ...
      <div className="flex flex-col justify-center pb-10">
        <div className="mt-8">
          <p className="s:text-xl font-bold text-lg">
            3월 18일 면접 시간 조정을 위한 월요일 수업이 끝나는 시간
          </p>
          <div className="input-with-placeholder relative w-full h-[64px] flex-shrink-0 border border-[#464646] border-solid rounded-[10px] mt-4">
            <input
              value={finish_time}
      ...
      <div className="flex flex-col justify-center items-center">
        <button
          ...
          className="w-full s:w-80 h-16 bg-ocean disabled:bg-[#B9B9B9] rounded-[10px] mt-28 mb-32 text-[#FFFFFF]"
