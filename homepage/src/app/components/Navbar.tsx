            ...
            <div className="flex justify-between">
              <Link href="/" key="home">
                <Image
                  ...
                  className="ml-[20px] my-[2px] lg:ml-[12.5vw] sm:mt-0 w-[130px] sm:w-[165px] lg:w-[12.5vw] h-[24px] sm:h-[30px] lg:max-w-[10vw] max-w-[165px] max-h-[30px]"
                  priority
                />
              </Link>
                ...
                >
                  {showMenu ? (
                    ...
                    <Image
                      ...
                      height={32}
                      alt="hamburger"
                      className="w-[30px] h-[30px] sm:w-[32px] sm:h-[32px] focus:border-none active:border-none"
                    />
                  )}
                </button>
              </div>
