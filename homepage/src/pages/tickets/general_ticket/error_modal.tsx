...
const Error_modal = () => {
    ...
    return !isClose ? (
        <div onClick={handleOverlayClick} className= "fixed z-50 top-0 left-0 right-0 bottom-0 bg-[#0000008a] flex justify-center items-center">
            <div className="font-pretendard w-[200px] h-[200px] sm:w-[580px] sm:h-[280px] bg-[#FFF] flex-shrink-0 fixed rounded-[10px] z-20">
                ...
                <div className="flex flex-col items-center text-center content-center mt-[12px] sm:mt-[40px] leading-normal">
                    ...
                    <button onClick={() => window.location.reload()}  className="mt-[12px] sm:mt-[20px] flex items-center w-[70px] h-[20px] sm:w-[100px] sm:h-[24px] justify-center rounded-[4px] bg-[#281CFF] text-[white] text-[8px] sm:text-[12px] font-[700] leading-[17px] text-center hover:bg-[white] hover:text-[#281CFF] hover:border-[#281CFF] transition-all duration-450 border-[1px] sm:border-[2px] border-[#281CFF]">다시 입력하기</button>
                    <Link href="general_ticket/delete">
                    <button className="mt-[12px] sm:mt-[20px] flex items-center  w-[85px] h-[20px] sm:w-[120px] sm:h-[24px] justify-center rounded-[4px] bg-[#D3D3D3] text-[white] text-[8px] sm:text-[12px] font-[700] leading-[17px] text-center hover:bg-[white] hover:text-[#281CFF] hover:border-[#281CFF] transition-all duration-450 border-[1px] sm:border-[2px] border-[#D3D3D3]">예매내역 확인하기</button>
                    </Link>
                </div>
                </div>
        </div>
