...
export default function Notice(){
    return(
        <div className="w-full py-24 flex flex-col justify-center items-center">
            <Image src={divider} alt="notice" className="w-[50px] h-[11px] s:w-[75px] s:h-[17px]"/>
            <p className="font-Gotham text-2xl x:text-3xl s:text-5xl mt-4 mb-6 font-bold">Information</p>
...
function Info_Schedule(){
    return(
        <div className="w-[300px] x:w-[420px] h-auto x:h-[184px] rounded-[10px] border-ocean bg-white border-2 py-8 px-10 m-6">
            ...
            <p className="text-sm mt-8">
                지원서 마감 : ~ 2024.03.15 (금) 23:59까지<br/>
                보컬부문 지원 영상 : ~ 2024.03.15 (금) 23:59까지
            </p>
        </div>
    )
}
    ...
    return(
        <div className="w-[300px] x:w-[420px] s:w-[580px] h-auto rounded-[10px] border-ocean bg-white border-2 py-8 px-10 m-6">
            ...
            <p className="text-sm mt-8">
                ...
                4. 기타 문의사항은 깔루아 카카오톡 플러스 친구 및 인스타그램 DM을 통해 문의 부탁드립니다.
            </p>
        </div>
    )
}