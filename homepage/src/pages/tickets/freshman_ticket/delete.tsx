    ...
    <div className="h-[100vh] sm:h-[650px] min-h-screen">
      <Background>
        <div className="font-pretendard mx-[12.5vw] flex items-center flex-col mb-[84px] ">
          ...
          <div className="mt-8 sm:mt-[48px] mx-auto w-[70vw] sm:w-[400px] md:w-[516px] h-[64px] flex rounded-[10px] items-center text-center content-center border-[1px] border-solid bg-[#FFF] border-[#000] outline-none">
            <input
              type="text"
          ...
          {searched && (
            <div className="mt-8 sm:mt-[48px]items-center content-center flex flex-col ">
              <Ticket_info reservation_id={reservation_id} buyer={buyer} />
              <div className="w-[75vw] sm:w-[400px] md:w-[514px] h-[64px] mt-[48px] mx-auto flex items-center">
