    ...
    <nav>
      {showMenu && (
        <div
          ...
          className="fixed inset-0 h-[full] bg-black bg-opacity-50 z-40"
        />
      )}
          ...
          <div className="lg:flex pt-[16px] sm:pt-[30px]">
            <div className="flex justify-between">
              <Link href="/" key="home">
                <Image
                  ...
                  className="ml-[20px] my-[2px] lg:ml-[12.5vw] sm:mt-0 w-[105px] sm:w-[165px] lg:w-[12.5vw] h-[18px] sm:h-[30px] lg:max-w-[10vw] max-w-[165px] max-h-[30px]"
                  priority
                />
              </Link>
              <div className="lg:hidden z-50 ">
                <button
                  ...
                  onClick={isClose ? handleIsClose : toggleMenu}
                >
                  {showMenu ? (
                    <Image
                    ...
                    <Image
                      src="/assets/images/layout/hamburger.svg"
                      width={32}
                      height={32}
                      alt="hamburger"
                      className="w-[22px] h-[22px] sm:w-[32px] sm:h-[32px] focus:border-none active:border-none"
                    />
                  )}
                </button>
              </div>
            ...
            >
              <ul
                className={`${
                  showMenu
                    ? "flex-col py-[40px] mt-[117px] mb-4 "
                    : " lg:w-[50vw] flex-col lg:flex lg:flex-row"
                }`}
              >
                {Links.map((link) => (
                  <Link
                  ...
                  >
                    <div
                      className={`${
                        showMenu
                          ? "flex w-105 h-28 flex-col justify-center flex-shrink-0 text-black text-center font-bold text-lg mb-[78x]"
...
>>>>>>> 9cbd578e7b2ef02540d777ba04a1e8de5c7c6387
                    </div>
                  </Link>
                ))}
              </ul>
