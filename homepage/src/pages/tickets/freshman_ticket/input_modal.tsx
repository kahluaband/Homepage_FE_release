...
const Input_modal = () => {
    ...
    return !isClose ? (
        <div onClick={handleOverlayClick} className= "fixed z-50 top-0 left-0 right-0 bottom-0 bg-[#0000008a] flex justify-center items-center">
            <div className="font-pretendard w-[250px] h-[210px] sm:w-[580px] sm:h-[290px] bg-[#FFF] flex-shrink-0 fixed rounded-[10px] z-20">
                <button onClick={handleIsClose} className="ml-[222px] mt-[8px] h-[22px] sm:h-[30px] sm:ml-[550px] flex-col items-center flex justify-center">
