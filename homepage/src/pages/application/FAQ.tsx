    ...
    return(
        ...
        <div className="s:pb-16">
            ...
            <div dir="rtl" className="py-8 px-8 pt-8 sm:px-16 md:pt-24 lg:px-64 flex flex-row items-center">
                ...
                <div className="bg-ocean w-full sm:w-[352px] h-auto sm:h-20 flex items-center rounded-3xl md:ps-8 text-[#EEEEEE] text-sm z-20 mt-2 p-4">
            ...
            <div dir="ltr" className="px-8 sm:px-20  lg:px-64 flex flex-row items-center">
                ...
                <div className="bg-[#EEEEEE] w-full sm:w-[512px] h-auto sm:h-28 flex items-center rounded-3xl md:ps-6 text-sm z-20 p-4">
            ...
            <div dir="rtl" className="px-8 sm:px-16 md:pt-8 lg:px-64 flex flex-row items-center">
                ...
                <div className="bg-ocean w-full sm:w-[380px] md:w-[476px] h-auto s:h-12 flex items-center rounded-3xl s:ps-8 mt-12 text-[#EEEEEE] text-sm z-20 p-4">
            ...
            <div dir="ltr" className="px-8 sm:px-20 lg:px-64 flex flex-row items-center">
                ...
                <div className="bg-[#EEEEEE] w-full sm:w-[360px] h-auto md:h-20 flex items-center rounded-3xl md:ps-6 mt-8 md:mt-4 text-sm z-20 p-4">
                    네! 저도 자율전공이랍니다.<br/>
